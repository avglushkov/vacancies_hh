""" module for working with User menu """
...
def print_vacancies(file_to_print) -> None:
...
def menu_search_params(raw_file_path, source_file_path) -> None:
...
def menu_top_salary(raw_file_path, source_file_path) -> None:
...
def menu_filter_by_city(raw_file_path , source_file_path) -> None:
...
def menu_filter_by_word(raw_file_path , source_file_path) -> None:
...
def menu_remove_vacancy(raw_file_path, source_file_path) -> None:
...
def menu_new_vacancy(raw_file_path, source_file_path) -> None:
    """ функция вывода меню ввода новой вакансии """

    print('\nДОБАВЛЯЕМ В СПИСОК НОВУЮ ВАКАНСИЮ\n')

    vacancy_address: dict
    vacancy_salary: dict
    new_vacancy: Vacancy
    ...
    while True:
        vacancy_salary_from: Optional[str | int]
    ...
    while True:
        vacancy_salary_to: Optional[str | int]
    ...
    while vacancy_salary_from > vacancy_salary_to:
        print('Вы указали верхний уровень зарплаты ниже нижнего')
    ...
    new_vacancy = Vacancy(vacancy_id,
                          vacancy_name,
                          vacancy_url,
                          vacancy_salary,
                          vacancy_address,
